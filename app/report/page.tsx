...
import { createUser, getUserByEmail, createReport, getRecentReports, updateRewardPoints } from '@/utils/db/actions';
...
export default function ReportPage() {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      try {
        const parsedResult = JSON.parse(text.replace(/```json|```/g, '')); // Remove Markdown formatting if present
      ...
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-lg mb-12">
        ...
        {preview && (
          <div className="mt-4 mb-8">
            <Image src={preview} alt="Waste preview"
